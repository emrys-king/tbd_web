---
layout: project
title: 'Community-Based Learning Models in STEM'
author-profile: true
collection: projects
sort_date: 2023
display_date: "2023"
...
<object data="{{ site.url }}{{ site.baseurl }}/files/phys070poster.pdf" type="application/pdf" width="1100px" height="850px">
    <embed src="{{ site.url }}{{ site.baseurl }}/files/phys070poster.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="{{ site.url }}{{ site.baseurl }}/files/phys070poster.pdf">Download PDF</a>.</p>
    </embed>
</object>